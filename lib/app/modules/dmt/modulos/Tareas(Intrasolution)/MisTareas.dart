...
final String sc_id;
  ...
  const MisTareas({Key? key, required this.sc_id}) : super(key: key);
                                                      ...
                                                      child: Column(
                                                        children: [
                                                          Row(
                                                            ...
                                                            children: [
                                                              Text("${snapshot.data![index]['nombre_subtipo_tarea']}", style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold),),
...
//
                                                              ...
                                                              Row(
                                                                ...
                                                                Container(
                                                                  ...
                                                                  child: ElevatedButton(
                                                                      ...
                                                                      child: FittedBox(child: Text("${snapshot.data![index]['nombre_tipo_tarea']}", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold),))),
                                                                )
                                                                ],
                                                              ),
                                                          ...
                                                          SizedBox(width: 8,),
                                                          Text("${proy_modulo}", style: TextStyle(fontWeight: FontWeight.w500, fontSize: 12, color: Colors.black87),),
                                                            ],
                                                          )
                                                          */
...
//Request JSON directo
  Future <List< dynamic>> RequestMisTareas() async {
    ...
    var url = '${Host.host}pr_ws_tareas_horas?usuario_id=${widget.sc_id}';
