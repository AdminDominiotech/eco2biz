...
class _LoginBodyState extends State<LoginBody> {
  ...
  final userTxt = TextEditingController(text: '');
  //final userTxt = TextEditingController(text: 'cesar.cueva');
  final passTxt = TextEditingController(text: '');
        ...
        body: BlocListener<LoginBloc, LoginState>(
          ...
          listener: (context, state) async {
            ...
            if (state is Successful) {
              Nav.replace(
                context,
                CompanyBodyIntra(user_login: '${userTxt.text.trim()}',  ),
              );
              return;
            }
  ...
  void _login(BuildContext context) {
    ...
    if (settings.setting == null) {
      ...
      GetIt.I<DioMicroServices>().msDio.options.headers = {
        ...header,
        'userLogin': '${userTxt.text.trim()}@eco2biz_demo',
